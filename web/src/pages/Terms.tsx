  ...
  return (
    <>
      ...
      <main className="screen info">
        ...
        <p className="lead">
          By using Bourbon Roam you agree to these terms. Please read them — they
        ...
        <p>
          ...
          States) to use Bourbon Roam. By using the app you confirm that you are.
        ...
        <p>
          ...
          shown for identification and education (nominative use). Bourbon Roam is
        ...
        <p>
          To the maximum extent permitted by law, Bourbon Roam is not liable for any
