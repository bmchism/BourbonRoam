    ...
    <>
      ...
      <main className="screen info">
        <div className="page-title">
          ...
          <h1>About Bourbon Roam</h1>
        </div>

        <p className="lead">
          Bourbon Roam turns any get-together into a guided bourbon tasting. Build a
        ...
        <p>
          Bourbon Roam is independent. Bottle names, labels, and logos are trademarks
