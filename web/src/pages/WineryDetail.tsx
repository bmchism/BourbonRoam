    ...
    <>
      ...
      <main className="screen">
        ...
        <div className="spec-grid">
          ...
          {winery?.masterDistiller && <div className="spec"><div className="k">Winemaker</div><div className="v">{winery?.masterDistiller}</div></div>}
          {winery?.mashBill && winery?.mashBill.length > 0 && (
            <div className="spec full"><div className="k">Mash Bill</div><div className="v">{winery?.mashBill.join(", ")}</div></div>
          )}
          {winery.website && (
