    ...
    <div className="landing">
      ...
      >
        ...
        <div className="land-hero-overlay">
          ...
          <p className="land-hero-sub">
            Turn any get-together into a guided bourbon tasting — pour, score each
      ...
      <section className="land-about">
        <div className="section-head land-center">
          ...
          <h2>Your bourbon companion</h2>
        </div>
        <p className="land-sub land-center-text">
          Bourbon Roam is a guided home for bourbon exploration. Build a flight,
