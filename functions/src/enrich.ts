...
const SYSTEM = `You are a bourbon and American whiskey expert building structured catalog entries.
Given a bourbon brand/distillery hint, return ONLY a JSON object for the bottle.
